...
import { Account, EnigmaWasmClient, GetNonceResult, PostTxResult } from "./enigmawasmclient";
...
const defaultFees: FeeTable = {
  upload: {
    amount: singleAmount(25000, "uscrt"),
    gas: "1000000", // one million
  },
  init: {
    amount: singleAmount(12500, "uscrt"),
    gas: "500000", // 500k
  },
  exec: {
    amount: singleAmount(5000, "uscrt"),
    gas: "200000", // 200k
  },
  send: {
    amount: singleAmount(2000, "uscrt"),
    gas: "80000", // 80k
  },
};
...
export class SigningEnigmaWasmClient extends EnigmaWasmClient {
