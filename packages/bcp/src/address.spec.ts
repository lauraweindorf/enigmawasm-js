...
describe("address", () => {
  describe("pubkeyToAddress", () => {
    it("works for Secp256k1 compressed", () => {
      ...
      expect(pubkeyToAddress(pubkey, prefix)).toEqual("enigma1h806c7khnvmjlywdrkdgk2vrayy2mmvf9rxk2r");
    });
    ...
    it("works for Secp256k1 uncompressed", () => {
      ...
      expect(pubkeyToAddress(pubkey, prefix)).toEqual("enigma1pkptre7fdkl6gfrzlesjjvhxhlc3r4gmmk8rs6");
    });
    ...
    it("works for Ed25519", () => {
      ...
      expect(pubkeyToAddress(pubkey, prefix)).toEqual("enigma1pfq05em6sfkls66ut4m2257p7qwlk448h8mysz");
    });
  });
});
